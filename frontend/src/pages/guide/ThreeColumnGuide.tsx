...
export default function ThreeColumnGuide() {
  return (
    <SgDsLibraryStack
    ...
    >
      ...
      >
        ...
        <SgDsLibrarySidebarGroup seeAllIcon="chevron-right" />

        <SgDsLibrarySidebarGroup style={{ height: 'fit-content' }}>
          <SgDsLibrarySidebarItem emphasized={true} badgeVariant="subtle" icon="plus" label="작품 만들기" active={false} />
        </SgDsLibrarySidebarGroup>

        <SgDsLibrarySidebarGroup>
          <SgDsLibrarySidebarItem icon="house" label="홈" active={true} />
          <SgDsLibrarySidebarItem icon="book-marked" label="구매목록" active={false} />
          <SgDsLibrarySidebarItem badge="12" icon="bell-dot" label="알림" active={false} />
        </SgDsLibrarySidebarGroup>

        <SgDsLibrarySidebarGroup count="45" seeAllLabel="모두보기" label="팔로잉">
          <SgDsLibrarySidebarFollowRow avatarSrc="https://i.pinimg.com/736x/ac/30/ad/ac30ad5b4d550027ff5be9fe95e3f196.jpg" size="sm" name="Hailey Luna" initials="HL" avatarTone="brand" status="live" tail="LIVE" tailStatus="live" tailVariant="plain" as="button" />
          <SgDsLibrarySidebarFollowRow avatarSrc="https://i.pinimg.com/1200x/b9/45/02/b94502342dfd29c213a99bb1d93c151d.jpg" size="sm" name="NeoVoice" initials="NV" avatarTone="teal" tail="방송중" as="button" />
          <SgDsLibrarySidebarFollowRow avatarSrc="https://i.pinimg.com/1200x/e8/df/8e/e8df8ee3fd256e1fa1b1714a59d03517.jpg" size="sm" name="코다 / Koda" initials="KO" avatarTone="amber" tail="작업중" as="button" />
          <SgDsLibrarySidebarFollowRow avatarSrc="https://i.pinimg.com/1200x/ca/70/2c/ca702cddd216a2990f402aa303f4a03e.jpg" size="sm" name="Ren Morimoto" initials="RM" avatarTone="purple" tail="5분" as="button" />
          <SgDsLibrarySidebarFollowRow avatarSrc="https://i.pinimg.com/736x/ac/30/ad/ac30ad5b4d550027ff5be9fe95e3f196.jpg" size="sm" name="aether.studio" initials="AT" avatarTone="coral" tail="3시간" as="button" />
        </SgDsLibrarySidebarGroup>
      </SgDsLibrarySidebar>
      ...
      <SgDsLibraryStack
        align="center"
        style={{ width: '100%', paddingTop: 'var(--ds-spacing-space-3)', overflow: 'hidden', height: '100%', flex: '1 1 auto', minWidth: '600px' }}
        direction="column"
        gap="none"
      >
        <SgDsLibraryStack
        ...
        >
          ...
          <SgDsLibraryStack
            ...
            data-wb-bg-token-collection="sg-ds-library-semantic-color"
            background="none"
            style={{ height: 'var(--ds-spacing-space-16)', width: '100%', paddingTop: 'var(--ds-spacing-space-2)', top: '0px', position: 'sticky', zIndex: 1, paddingBottom: 'var(--ds-spacing-space-3)' }}
            as="header"
            direction="row"
            align="center"
            gap="md"
          ...
          >
            ...
            >
              ...
              <SgDsLibraryStack style={{ height: '320px' }} as="div" radius="none" direction="column" align="stretch" justify="start" gap="md" padding="none" background="none">
                <SgDsLibraryCard style={{ height: '100%' }} data-wb-bg-token="surface-card" data-wb-bg-token-collection="sg-ds-library-semantic-color" title="Header Section" variant="bare" gap="md" padding="md" />
              </SgDsLibraryStack>

              {/* Section 1 */}
              <SgDsLibraryStack as="div" radius="none" direction="column" align="stretch" justify="start" gap="md" padding="none" background="none">
                <SgDsLibrarySectionTitle title="Section1" icon="sparkles" as="header" align="start" iconTone="purple" showIcon={false} subtitleTone="tertiary" subtitleVariant="body-sm" titleAs="h4" titleVariant="heading-4" titleWeight="bold" wrapActions={true} />
              </SgDsLibraryStack>

              {/* Section 2 */}
              <SgDsLibraryStack as="div" radius="none" direction="column" align="stretch" justify="start" gap="md" padding="none" background="none">
                <SgDsLibrarySectionTitle title="Section2" icon="sparkles" as="header" align="start" iconTone="purple" showIcon={false} subtitleTone="tertiary" subtitleVariant="body-sm" titleAs="h4" titleVariant="heading-4" titleWeight="bold" wrapActions={true} />
              </SgDsLibraryStack>
            </SgDsLibraryStack>
      ...
      >
        {/* MY CARD */}
        <SgDsLibraryUserCard style={{ flex: '0 0 auto' }} action2Variant="primary" action1Variant="ghost" tint="default" variant="outline">
          <SgDsLibraryUserCardHead style={{ height: '84px' }} name="Name" avatarSrc="https://i.pinimg.com/1200x/e8/df/8e/e8df8ee3fd256e1fa1b1714a59d03517.jpg">
            <SgDsLibraryUserBlock
              avatarSize="lg"
              avatarSrc="https://i.pinimg.com/736x/cb/12/b2/cb12b2f39982bf66734cd7e5a34eb891.jpg"
              style={{ width: '100%' }}
            ...
            >
              ...
              >
                <SgDsLibraryPopoverList>
                  <SgDsLibraryPopoverItem icon="circle-user">프로필</SgDsLibraryPopoverItem>
                  <SgDsLibraryPopoverItem icon="layout-dashboard">대쉬보드</SgDsLibraryPopoverItem>
                  <SgDsLibraryPopoverItem icon="settings">설정</SgDsLibraryPopoverItem>
                </SgDsLibraryPopoverList>
              </SgDsLibraryButtonPopover>
            </SgDsLibraryUserBlock>
          ...
          <SgDsLibraryUserCardSection style={{ height: 'fit-content' }} tint="sunken">
            <SgDsLibraryCreditBalanceCard showRows={true} showActions={true} action2Label="이력" action1Label="충전하기">
              <SgDsLibraryCreditBalanceCardRow style={{ height: '21px' }} label="후원자" value="1,455" delta="+6" deltaTone="positive" />
              <SgDsLibraryCreditBalanceCardRow style={{ height: '21px' }} label="오늘 받은 후원" value="+240CRD" delta="+18%" deltaTone="positive" />
            </SgDsLibraryCreditBalanceCard>
          </SgDsLibraryUserCardSection>
        </SgDsLibraryUserCard>
        ...
        <SgDsLibraryStack style={{ height: 'fit-content' }} direction="column" gap="none">
          ...
          <SgDsLibraryTopicRow style={{ height: '55px' }} rank={2} title="#synthwave" sub="이번 주 새 트랙 218개" delta="+94%" deltaTone="neutral" divider={true} />
        ...
        {/* Follow suggestions */}
        <SgDsLibraryStack as="section" direction="column" gap="xs" aria-label="Suggested creators">
